...
class DetectMultiBackend(py_nndct.nn.NndctQuantModel):
    def __init__(self):
        ...
        self.module_140 = py_nndct.nn.Conv2d(in_channels=128, out_channels=33, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #DetectMultiBackend::DetectMultiBackend/DetectionModel[model]/Detect[model]/Detect[24]/Conv2d[m]/ModuleList[0]/9285
        self.module_141 = py_nndct.nn.Conv2d(in_channels=256, out_channels=33, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #DetectMultiBackend::DetectMultiBackend/DetectionModel[model]/Detect[model]/Detect[24]/Conv2d[m]/ModuleList[1]/9304
        self.module_142 = py_nndct.nn.Conv2d(in_channels=512, out_channels=33, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #DetectMultiBackend::DetectMultiBackend/DetectionModel[model]/Detect[model]/Detect[24]/Conv2d[m]/ModuleList[2]/9323
